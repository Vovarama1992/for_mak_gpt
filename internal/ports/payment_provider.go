...
type PaymentProvider interface {
	...
	CreateSubscriptionPayment(ctx context.Context, botID string, telegramID int64, planCode string, price float64) (payURL string, providerPaymentID string, err error)
}
