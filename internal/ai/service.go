...
Не проси повторно файлы или изображения, если они уже присутствуют в истории и относятся к запросу.
Отвечай на запрос, используя текст последнего сообщения и связанные с ним файлы из истории.
`
