...
func (s *recordService) AddImage(ctx context.Context, botID string, telegramID int64, role string, file multipart.File, filename, contentType string) (int64, error) {
